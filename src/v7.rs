// Goal:
//      - Improve String parsing performance by not using Strings at all, instead use raw bytes &[u8]
//
// Change:
...
pub fn run(measurements_path: &str) -> String {
    ...
    let mut buf_reader = BufReader::with_capacity(1 << 20, measurements_file);
